            ...
            <div>
              ...
              <ScrollAnimation animationType="fadeInUp" delay={100}>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight">
                  ...
                  <span className="block text-blue-400 mt-2">for Modern Businesses</span>
                </h1>
              </ScrollAnimation>
              ...
              <ScrollAnimation animationType="fadeInUp" delay={300}>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    href="/enterprise"
                    className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg text-lg font-semibold transition-all transform hover:scale-105 shadow-lg hover:shadow-blue-600/50"
                  >
                    Get Started
                  </Link>
                  <Link
                    href="/about"
                    className="bg-gray-800/50 hover:bg-gray-700/50 backdrop-blur-sm text-white px-8 py-3 rounded-lg text-lg font-semibold transition-all border border-gray-700 hover:border-gray-600"
                  >
                    Learn More
                  </Link>
                </div>
            ...
            <div className="relative">
              <ScrollAnimation animationType="fadeInRight" delay={400}>
                <div className="relative">
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 opacity-20 blur-xl animate-pulse -z-10"></div>
                </div>
              </ScrollAnimation>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <ScrollAnimation animationType="scaleIn" delay={100}>
            ...
            <ScrollAnimation animationType="scaleIn" delay={200}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all transform hover:scale-105">
                <div className="text-5xl md:text-6xl font-bold text-blue-400 mb-3 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
                  99.9%
                </div>
            ...
            <ScrollAnimation animationType="scaleIn" delay={300}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all transform hover:scale-105">
                <div className="text-5xl md:text-6xl font-bold text-blue-400 mb-3 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
                  50+
                </div>
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollAnimation animationType="fadeInUp" delay={200}>
            <Link
              href="/contact"
              className="bg-white text-blue-600 hover:bg-gray-100 px-10 py-4 rounded-lg text-lg font-semibold transition-all transform hover:scale-110 shadow-2xl inline-block"
            >
              Contact Sales
            </Link>
          </ScrollAnimation>
